...
- [x] パフォーマンス計測（100ページ規模でクリーンビルド10秒以内、増分ビルド1秒以内）とボトルネック改善
- [x] アクセシビリティ対応の総点検（キーボード操作、aria属性、WCAG AAコントラスト）
- [x] JS無効環境での本文閲覧確認
- [x] エラーハンドリング表（仕様書2.8）の全ケース網羅テスト
- [x] MkDocsGen自身のドキュメントをMkDocsGenでビルドするドッグフーディング
- [x] READMEと利用ドキュメントの整備（テンプレートコンテキスト変数の公開仕様化を含む）
